class DetailsModle {
  ...
  DetailsModle.fromJson(Map<String, dynamic> json) {
    ...
    data = json['data'] != null ? new DatailsData.fromJson(json['data']) : null;
  }
...
class DatailsData {
  ...
  DatailsData({this.goodInfo, this.goodComments, this.advertesPicture});

  DatailsData.fromJson(Map<String, dynamic> json) {
